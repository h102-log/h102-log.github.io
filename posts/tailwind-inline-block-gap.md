...
description: "inline-block 요소 사이의 약 4px 공백이 왜 생기는지, 그리고 안전하게 제거하는 방법"
tag: "css"
category: "FrontEnd"
group: "Tailwind CSS"
---
...
이번 글에서는 공백이 생기는 이유를 먼저 확인하고, 많이 쓰는 해결 패턴을 예시 코드와 함께 정리해보겠습니다.
